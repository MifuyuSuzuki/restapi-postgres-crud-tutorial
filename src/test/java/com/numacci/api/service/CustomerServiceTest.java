...
public class CustomerServiceTest {
    ...
    @Mock //@InjectMocks を付けたオブジェクト（=CustomerServiceImpl）のフィールドを Mock化する
    private CustomerMapper mapper;
    @InjectMocks  //Mockitoのライブラリがよしなにインスタンス化してくれる
    private CustomerServiceImpl service;

    @BeforeEach
    public void setup() {
        MockitoAnnotations.openMocks(this); //@Mock,@InjectionMockを有効にするために、MockitoAnnotationsを初期化する
    }
    ...
    public void testRegister() {
        ...
        //whenはMockの振る舞いを定義するためのstaticメソッド。
        //mapper.insertメソッドがコールされたら1を返却するように指定
        ...
        //whenで定義したMockのmapper.insertが1回だけコールされたことをverifyする
    }
